...
function fillEdit(elementName){
	...
	//var GIncident_id = document.getElementById('incident_report').value;
...
//		elementContents+="<select name='level' onchange='enterOrder(this.value)'>";
	    ...
	    //document.getElementById('fieldType2').value='incident_report';
...
<form id='edit_form' name='edit_form' action='edit_ccdr.php'  method='post'>
	...
	<br>
	<div align=left><font color=white>| | | | | | | | | | | | | | | | | | | |</font><input type="hidden" name='fieldType' id='fieldType' /> <input type="hidden" name="inc_report" value='<?php echo $incident_report?>' /> <input type=submit value='Edit' /></div>
	</form>
</body>