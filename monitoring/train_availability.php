...
//			echo "style='background-color:#67c2ef;';";
		...
		?>
		>	
		<td align=center rowspan=3><?php echo $row['index_no']; ?> </td>
<?php
...
?>
		<td align=center rowspan=3><?php echo $row3['new_index']." /<br> ".date("H:i",strtotime($row3['date_change'])); ?>  </td>
<?php
...
?>	
		<td align=center><a href='#' class="<?php echo $SRemove?>"  onclick='window.open("car_history.php?car_id=<?php echo $row['car_a']; ?>")'><?php echo $row['car_a']; ?></a></td><td rowspan=3>&nbsp;</td>
	<?php	
