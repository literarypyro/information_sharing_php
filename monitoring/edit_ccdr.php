...
//		$sql="select * from train_incident_view inner join level on train_incident_view.incident_id=level.incident_id where id='".$incident_report."'";
		...
		$approving_person=$row['approving_person'];
...
<tr><th>Level</th><td><?php echo $level; echo $levelClause; echo ". ".$condition; ?></td></tr>
...
<tr><th width=20%>Reported By</th><td width=50%><?php echo $reported_by; ?></td></tr>
<tr><th>Received By</th><td><?php echo $received_by; ?></td></tr>
<tr><th>Recommending Approval</th><td><?php echo $recommending_approval; ?></td></tr>
<tr><th>Approving Person</th><td><?php echo $approving_person; ?></td></tr>
...
<tr><th width=20%>DOTC</th><td width=50%><?php echo $dotc_action; ?></td></tr>
<tr><th>Maintenance Provider</th><td><?php echo $maintenance_action; ?></td></tr>
</table>
<br>
<br>
