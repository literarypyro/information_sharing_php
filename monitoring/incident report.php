...
<tr>
<td valign=top>DOTC</td><td><span name='remarks_space' id='remarks_space'> <textarea rows=5 cols=50 name='dotc' id='dotc'  class="span6 typeahead" id="typeahead" data-provide="typeahead" data-items="4" 
data-source='[""
<?php
$db2=new mysqli("localhost","root","","external");
$sql="select * from preencoded";
