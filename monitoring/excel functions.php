...
function saveProtected($workbook,$excelAPI,$workbookName)
{
	$objWriter = PHPExcel_IOFactory::createWriter($excelAPI, 'Excel5');
	$excelAPI->getActiveSheet()->getProtection()->setSheet(true);
	$excelAPI->getActiveSheet()->getProtection()->setPassword("123456");
