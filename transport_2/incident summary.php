...
for($i=0;$i<$nm;$i++){
	...
	$reported_by=$row['reported_by'];
		...
		if($incident_type=="rolling"){
			...
			$description="Index #".$row['index_no'].", Car(s) ".$carClause.", ".$location."  ".$direction.", ".$row['description'].", Reported By ".$reported_by.", ";
...
<td valign=center align=center><a href='#' onclick='deleteIncident("<?php echo $row['id']; ?>")'>X</a></td>
