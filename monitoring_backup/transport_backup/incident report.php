...
<form action='incident report.php' method='post'>
<select name='month'>
...
<td align=center><a href='#' onclick='window.open("incident details.php?ir=<?php echo $row['id']; ?>")'><?php echo $row['incident_no']; ?></a></td>
