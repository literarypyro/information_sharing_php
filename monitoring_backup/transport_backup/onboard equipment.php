...
$sql="select count(*) as equipt_count, equipt from incident_description where incident_id in (select incident_id from train_union where trainDate like '".$ccdr_date."%%') and equipt in (select id from equipment where category='OB') group by equipt";
...
<tr>
	...
	<td align=center><?php echo $cars-($equipment["Equipment_".$row['id']]['nw_count']*1); ?></td>
